...
const contacts = new Map(); // waId -> { sioProfile, history:[{role,text,at}], summary, programScheduledAt, programSent, _welcomed }
...
app.post('/sio-webhook', async (req, res) => {
  try {
    ...
    if (!lead.phone) {
      ...
      // on répond 200 pour éviter les retries
